package implementation.doors100;
...
import implementation.doors100.enums.DoorState;

import java.util.HashMap;
import java.util.Map;

public class Doors100 {
    private Map<Integer,Enum> doorMap = new HashMap<>();

    public Map<Integer, Enum> getDoorMap() {
        return doorMap;
    }

    public void createDoorMap(){
        for (int i = 1;i <= 100; i++){
            doorMap.put(i, DoorState.CLOSED);
        }
    }

    public void createDoorArray(){
